...
class Modules extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->validator('sistema/Module_Validation');
        ...
        $this->Module_Validation = new Module_Validation();
    }
    ...
    public function pagination()
    {
        ...
        $response = $this->Module_Repository_Service->find_paginate($module_dto, $options_dto);
