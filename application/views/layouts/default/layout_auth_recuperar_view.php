...
<body>
    ...
    <div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('<?php echo base_url(); ?>assets/img/bg/1.jpg');">
            ...
            <div class="card">
                ...
                <div class="card-footer py-3 px-4 px-sm-5">
                    <div class="text-center text-muted">
                        <?php echo lang("auth_already_have_an_account"); ?> <a href="<?php echo base_url("auth/index"); ?>"><?php echo lang("auth_sign_in");?></a>
                    </div>
                </div>
            </div>
