<h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-3 mb-4">
    <div>
        <span class="text-muted font-weight-light"><?php echo lang($slug . '_title'); ?> /</span>
        <?php echo lang($slug . "_list"); ?>
    </div>

    <a href="<?php echo base_url($slug . '/form');?>" type="button" class="btn btn-primary rounded-pill d-block"><span
...
<div class="card">
    ...
    <div class="card-datatable ">
        <div class="row">
            <div class="col-md-6">
                <form id="form-limit-<?php echo $slug; ?>" class="form-inline">
                    <div class="form-group mt-2 mb-2">
                        <label for="basic-table-mostrar" class="ml-3 mr-3"><?php echo lang('general_text_show'); ?>
                            :</label>
                        <?php echo form_dropdown("limit", get_select_limit_pagination(), PAGINATION_LIMIT_PER_PAGE,'class="custom-select"'); ?>
                    </div>
                </form>
            </div>
            <div class="col-md-6">
                <form id="form-search-<?php echo $slug; ?>" class="form-inline d-flex justify-content-end mr-3">
                    <div class="form-group mt-2 mb-2 ">
                        ...
                        <button type="sibmit" class="btn btn-default btn-grid-search">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="container-pages-<?php echo $slug; ?> buttons-pagination"></div>
                <table id="table-<?php echo $slug; ?>" class="datatables-demo table table-striped table-bordered table-responsive">
                    <thead>
                        <tr>
                            ...
                            <th data-name="description" style="width: 30%;"><?php echo lang('modules_description'); ?>
                            </th>
...
<script id="template-table-<?php echo $slug; ?>" type="text/x-handlebars-template">
    <tr>
                <td>{{id}}</td>
                <td>{{name}}</td>
                <td>{{slug}}</td>
...
<script id="template-pages-<?php echo $slug; ?>" type="text/x-handlebars-template">
    <div class="row">
